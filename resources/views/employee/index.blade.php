...
<head>
    ...
    <title>Testing Index View</title>
</head>
...
<body>
    ...
    <div>
        <a class="button1" style="margin-top: 100px" href="{{ route('employee.create') }}">Create
            <div class="icon-1">
            ...
            <tbody>
                @foreach ($employees as $employee)
                    <tr>
                        ...
                        <td
                            style="display: flex ; align-items: center; justify-content: center; gap:5px ; position: relative;">
                            <button class="delete-button">

                                <a style="color: white; text-decoration: none; "
                                    href="{{ route('employee.edit', ['employee' => $employee]) }}">Edit</a>
                            </button>
                            <form style="display: flex; align-items: center ; margin-top:16px; "
                                action="{{ route('employee.destroy', ['employee' => $employee]) }}" method="post">
                                @csrf
                                @method('delete')
